            ...
            <Link to={"/"}>
              <a className="btn btn-ghost text-xl">
                <svg
                  width="130"
                  height="50"
                  className="DisplayNone_desktop-oversized__OPqkZ spacing_noMargin__Q_PsJ spacing_omr50__hkepU spacing_dmr30__cxy_w spacing_mmr15__qhwu1 spacing_tmr15__VKPzp"
          ...
          <div className="navbar-end">
            <div className="navbar-center hidden lg:flex items-center justify-center">
              <ul className="menu menu-horizontal px-1">
                <li>
                  <details>
                    <summary className="text-white text-[16px] font-semibold">
                      Explore
                    </summary>
                    <ul className="p-2">
                      <li
                      ...
                      <li
                        onClick={() => setSearch("social")}
                        className="text-black"
                      >
                        <a>Free Pexels</a>
                      </li>
                      <li
                        onClick={() => setSearch("blog")}
                        className="text-black"
                      >
                        <a>Blog</a>
                      </li>
                ...
                <li className="text-white text-[16px] font-semibold">
                  <a>License</a>
                </li>
                <li className="text-white text-[16px] font-semibold">
                  <a>Upload</a>
                ...
                <button className="btn bg-white btn-md">Join</button>
              </ul>
            </div>
          </div>
        </div>
